            ...
            <Card className={classes.root}>
              ...
              <CardContent>
                ...
                <Grid container xs={12} style={{ marginTop: "5vh" }}>
                  <Grid item xs={4}>
                    <img alt="something" src={"https://ichef.bbci.co.uk/news/660/cpsprodpb/3DAD/production/_104898751_gettyimages-844466808.jpg"} width="100" height="100"></img>
                  </Grid>

                  <Grid item xs={4}>
                    <img alt="something" src={"https://cdn.iconscout.com/icon/free/png-256/fast-food-1851561-1569286.png"} widdth="100" height="100" />
                  </Grid>
                  <Grid item xs={4}>
                    <img alt="something" src={"https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQkSAVE9O3nSGd_S8-rxXnGIOywMVqgSTH60ivV8vzOzm2QQZ73&usqp=CAU"} width="100" height="100" />
                  </Grid>
                </Grid>
              </CardContent>
