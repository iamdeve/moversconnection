...
import AdminTownModel from './adminTownModel';
...
const TownTable = (props) => {
  ...
  const handleTownDelete = (rowData) => {
    AdminContext1.handleItemDelete(rowData);
  };
                          ...
                          <Grid container direction="row">
                            <Grid item>
                              <Button
                                variant="contained"
                                color="primary"
                                onClick={() => handleEditTown(rowData)}>
                                Edit
                              </Button>
                            </Grid>
                            <Grid item>
                              <Button
                                ...
                                color="primary"
                                onClick={() => handleTownDelete(rowData._id)}>
                                Delete
                              </Button>
                            </Grid>
                          </Grid>
